...
Rut="C:\\Users\\SENA\\OneDrive - Universidad Nacional Abierta y a Distancia\\Desktop\\carpeta aparte del crud\\Base_Crud.xlsx"
Rut=r"C:\Users\SENA\OneDrive - Universidad Nacional Abierta y a Distancia\Desktop\carpeta aparte del crud\Base_Crud.xlsx"

def leer(ruta:str, extraer:str):
    Archivo_Exccel = load_workbook(ruta)
    Hoja_datos= Archivo_Exccel['Datos_del_Crud']
